...
class FundController extends Controller
{
    ...
    {
        return Template::load('admin', 'Sumber Dana', 'fund', 'view');
    }

    public function get_data_dt()
    {
        $data = Fund::latest()->get();

        return DataTables::of($data)
            ->addIndexColumn()
            ->addColumn('action', function ($row) {
                return '
                    <button type="button" id="upd" data-id="' . my_encrypt($row->id_fund) . '" class="btn btn-sm btn-relief-primary" data-bs-toggle="modal" data-bs-target="#modal-add-upd"><i data-feather="edit"></i>&nbsp;<span>Ubah</span></button>&nbsp;
                    <button type="button" id="del" data-id="' . my_encrypt($row->id_fund) . '" class="btn btn-sm btn-relief-danger"><i data-feather="trash"></i>&nbsp;<span>Hapus</span></button>
                ';
            })
            ->make(true);
    }
    ...
    {
        $data = Fund::select('id_fund AS id', 'nama AS text')->orderBy('id_fund', 'asc')->get();
    ...
    {
        $response = Fund::find(my_decrypt($request->id));
    ...
    public function del(Request $request)
    {
        ...
        if ($checking) {
            try {
                $data = Fund::find(my_decrypt($request->id));
