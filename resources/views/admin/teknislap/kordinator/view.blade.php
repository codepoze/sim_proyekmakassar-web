<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-kordinator-pengawaas-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route_role('admin.teknislap.kordinator.save') }}" method="POST">
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-kordinator-pengawaas-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route_role('admin.teknislap.kordinator.get_data_dt') }}",
        ...
        let untukUbahData = function() {
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route_role('admin.teknislap.kordinator.show') }}",
                    data: {
                        id: ini.data('id')
                    },
                    beforeSend: function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            $.ajax({
                                type: "post",
                                url: "{{ route_role('admin.teknislap.kordinator.del') }}",
                                dataType: 'json',
                                data: {
                                    id: ini.data('id'),
