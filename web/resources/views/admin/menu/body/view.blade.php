<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-menu-body-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
                ...
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.menu.body.save') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div id="form-show">
                            <div class="row">
                                <!-- begin:: id -->
                                <input type="hidden" name="id_menu_body" id="id_menu_body" />
                                <!-- end:: id -->
                                <div class="col-12">
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-menu-body-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
