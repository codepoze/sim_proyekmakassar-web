<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-ruas_item-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route_role('admin.ruas_item.save') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div id="form-show">
                            <div class="row">
                                <!-- begin:: id -->
                                <input type="hidden" name="id_ruas_item" id="id_ruas_item" />
                                <!-- end:: id -->
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="nama" class="form-control form-control-sm" name="nama" placeholder="Masukkan nama ruas item" />
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-ruas_item-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route_role('admin.ruas_item.get_data_dt') }}",
        ...
        let untukUbahData = function() {
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route_role('admin.ruas_item.show') }}",
                    data: {
                        id: ini.data('id')
                    },
                    beforeSend: function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            $.ajax({
                                type: "post",
                                url: "{{ route_role('admin.ruas_item.del') }}",
                                dataType: 'json',
                                data: {
                                    id: ini.data('id'),
