    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.pptk.save') }}" method="POST">
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-pptk-dt').DataTable({
                ...
                ajax: "{{ route('admin.pptk.get_data_dt') }}",
