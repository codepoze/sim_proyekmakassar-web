            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-pptk-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route_role('admin.pptk.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="email" name="email" placeholder="Masukkan Email" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-pptk-dt').DataTable({
                ...
                ajax: "{{ route_role('admin.pptk.get_data_dt') }}",
        ...
        let untukUbahData = function() {
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route_role('admin.pptk.show') }}",
                    data: {
                        id: ini.data('id')
                    },
                    beforeSend: function() {
