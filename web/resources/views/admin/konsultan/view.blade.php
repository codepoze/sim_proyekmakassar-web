...
<div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- begin:: untuk form -->
            <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.konsultan.save') }}" method="POST">
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-konsultan-dt').DataTable({
            ...
            ajax: "{{ route('admin.konsultan.get_data_dt') }}",
    ...
    let untukUbahData = function() {
        $(document).on('click', '#upd', function(e) {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: "{{ route('admin.konsultan.show') }}",
                data: {
                    id: ini.data('id')
                },
                beforeSend: function() {
