...
<!-- begin:: css local -->
@section('css')
<link rel="stylesheet" type="text/css" href="{{ asset_admin('vendors/css/extensions/toastr.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset_admin('css/plugins/extensions/ext-component-toastr.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset_admin('css/pages/dashboard-ecommerce.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset_admin('vendors/css/charts/apexcharts.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset_admin('css/plugins/charts/chart-apex.min.css') }}">
@endsection
<!-- end:: css local -->
...
<!-- begin:: js local -->
@section('js')
<script src="{{ asset_admin('vendors/js/extensions/toastr.min.js') }}"></script>
<script src="{{ asset_admin('js/scripts/pages/dashboard-ecommerce.min.js') }}"></script>
<script src="{{ asset_admin('vendors/js/charts/apexcharts.min.js') }}"></script>
@endsection
<!-- end:: js local -->