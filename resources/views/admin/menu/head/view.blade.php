<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-menu-head-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('admin.menu.head.save', session()->get('roles')) }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div id="form-show">
                            <div class="row">
                                <!-- begin:: id -->
                                <input type="hidden" name="id_menu_head" id="id_menu_head" />
                                <!-- end:: id -->
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="icon" class="form-control form-control-sm" name="icon" placeholder="Masukkan Icon" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="path" class="form-control form-control-sm" name="path" placeholder="Masukkan Path" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-menu-head-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('admin.menu.head.get_data_dt', session()->get('roles')) }}",
        ...
        let untukUbahData = function() {
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route('admin.menu.head.show', session()->get('roles')) }}",
                    data: {
                        id: ini.data('id')
                    },
                    beforeSend: function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            $.ajax({
                                type: "post",
                                url: "{{ route('admin.menu.head.del', session()->get('roles')) }}",
                                dataType: 'json',
                                data: {
                                    id: ini.data('id'),
